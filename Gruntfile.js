...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    // added by donghui
    // sass compile foundation framework
    sass: {
      dist: {
        options: {
          style: 'expanded'
        ...
        files: {
          'assets/linker/styles/css/foundation.min.css': 'assets/linker/styles/scss/foundation.scss',
          'assets/linker/styles/css/styles.min.css': 'assets/linker/styles/scss/styles.scss'
        }
      }
    },
